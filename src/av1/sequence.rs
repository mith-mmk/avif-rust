...
mod tests {
    ...
    fn sample_sequence_header() -> Vec<u8> {
        ...
        obus.iter()
            ...
            .expect("sample should contain a sequence header OBU")
            .payload
            .to_vec()
    }

    #[test]
    fn parses_sample_sequence_header() {
        let header = parse_sequence_header(&sample_sequence_header()).unwrap();
