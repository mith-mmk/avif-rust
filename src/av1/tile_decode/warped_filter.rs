//! AV1's 1/64-pixel warped-motion filter bank (AOMedia/libaom v3.13.1).
//!
//! The table is normative for the two-pass warped block filter. Keeping it in
//! its own module avoids mixing the large coefficient bank with prediction
//! control flow.
//!
//! Coefficients are transcribed from AOMedia/libaom v3.13.1 (BSD-2-Clause).

#[rustfmt::skip]
pub(crate) const AV1_WARPED_FILTERS: [[i16; 8]; 193] = [
[ 0,   0, 127,   1,   0, 0, 0, 0 ],
[ 0, - 1, 127,   2,   0, 0, 0, 0 ],
[ 1, - 3, 127,   4, - 1, 0, 0, 0 ],
[ 1, - 4, 126,   6, - 2, 1, 0, 0 ],
